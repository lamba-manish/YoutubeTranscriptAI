    ...
    def __init__(
        ...
        *,
        ...
        if api_key is None:
            ...
            api_key = "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"
        if api_key is None:
            raise OpenAIError(
